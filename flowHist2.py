...
frames = list(Path('/Users/zacswider/Desktop/optFlowTrash/bzOptFlow/imageSequence').iterdir())
frames.sort()
step = 4
framesToSkip = 1
...
n, bins = np.histogram(x, bins=16)                # Bin data and record counts
...
ax.set_theta_offset(0)                         # Set the direction of the zero angle
ax.set_yticks([])
